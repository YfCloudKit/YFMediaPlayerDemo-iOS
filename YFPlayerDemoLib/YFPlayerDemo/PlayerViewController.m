...
- (void)viewDidLoad {
    ...
    self.player = [[YfFFMoviePlayerController alloc] initWithContentURL:[NSURL fileURLWithPath:file] withOptions:NULL useDns:self.isDNS useSoftDecode:self.isSoftCode DNSIpCallBack:NULL appID:"" refer:"" bufferTime:self.bufferTime display:YES isOpenSoundTouch:YES];
